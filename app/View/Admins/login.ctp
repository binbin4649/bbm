...
<div class="login_outer">
    ...
    echo $this->Form->input("username", array("div" => false, "type" => "text", "label" => 'Username', "autofocus" => true, "class" => 'email'));
    ...
    <div class="login-as"><?php echo $this->Html->link("Forgot your Password?", '/admins/forgotpassword'); ?></div>

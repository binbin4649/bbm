...
<p>
スポーツは、賭けて観ると、100倍楽しい！！<br>
仮想ポイントを使った、仮想ブックメーカーです。無料で遊べます。<br>
賭けの対象（の情報）を、Book と呼びます。<br>
賭けるは、betです。<br>
賭けを作る人を、Book Makerと呼びます。</p>

<h4>遊び方</h4>
<ol>
<li>Facebookでログイン。右上の CONECT WITH FACEBOOK をクリック。</li>
<li>トップページから賭けたいBookを探してBet!</li>
<li>賭けたいBookがなかったら、自分で作ろう! Make Book!</li>
</ol>
...
<h4> 1） betする。</h4>
<p>
これが基本ですが、当然ながら勝たなければ増えません。<br>
※1book、合計100ポイントまでBetできます。
</p>
